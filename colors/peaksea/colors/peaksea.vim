...
elseif &background=='dark' 
  ...
  hi ErrorMsg		guifg=#000000	guibg=#800000	gui=NONE
  hi MoreMsg		guifg=#000000	guibg=NONE	gui=NONE
  hi Title		    guifg=#000000	guibg=NONE	gui=NONE
  hi WarningMsg		guifg=#000000	guibg=NONE	gui=NONE
  hi WildMenu		guifg=#000000	guibg=#d0d090	gui=NONE
  hi Folded		    guifg=#000000	guibg=#333333	gui=NONE
  hi FoldColumn		guifg=#000000	guibg=NONE	gui=NONE
